...
public class MainActivity extends AppCompatActivity implements RollLengthDialogFragment.OnRollLengthSelectedListener {
    ...
    private Menu mMenu; // Menu declaration
...
//        }
    ...
    // showDice to display the dice
    private void showDice() {
        // Display only the number of dice visible, according to user needs
        for (int i=0; i<mVisibleDice; i++) {
            // Get drawable
            Drawable diceDrawable = ContextCompat.getDrawable(this, mDice[i].getmImageId());

            // Set iamge drawable to be related to this varaible
